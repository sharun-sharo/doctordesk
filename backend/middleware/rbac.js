...
const receptionistOnly = requireRole(ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.RECEPTIONIST);
const staffOnly = requireRole(ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.DOCTOR, ROLES.RECEPTIONIST);
