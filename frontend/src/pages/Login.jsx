...
const CONTACT_PHONE_DISPLAY = '+91 95665 51345';
const CONTACT_WHATSAPP = 'https://wa.me/919566551345';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] login-page-bg">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-[1fr,minmax(380px,28rem)] lg:min-h-[calc(100dvh-4rem)]">
        {/* Right: Login card – first on mobile, right column on desktop */}
        <div className="order-1 lg:order-2 px-4 py-8 lg:py-14 lg:pl-0 lg:pr-8 xl:pr-12 flex flex-col justify-center lg:sticky lg:top-20 lg:self-start lg:max-h-[calc(100dvh-6rem)]">
...
<div className="mb-5 flex justify-center">
        ...
        <div className="order-2 lg:order-1 px-4 py-10 sm:px-6 sm:py-12 lg:px-10 lg:py-14 xl:px-16 overflow-y-auto pb-[max(2rem,env(safe-area-inset-bottom))] flex flex-col">
          ...
          <section className="relative mb-12 sm:mb-16 lg:mb-20 rounded-2xl lg:rounded-3xl overflow-hidden min-h-[360px] sm:min-h-[420px] flex flex-col justify-end border border-slate-200/50 shadow-xl shadow-slate-200/30">
            ...
            <div className="relative z-10 p-6 sm:p-8 lg:p-10">
              <motion.p
                ...
                className="text-xs font-semibold uppercase tracking-widest text-primary-300 mb-3"
              >
              ...
              <motion.h1
                ...
                className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-white tracking-tight leading-[1.08] max-w-2xl"
              >
              ...
              <motion.p
                ...
                className="mt-4 text-base sm:text-lg text-white/90 leading-relaxed max-w-lg"
              >
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-4">
                  {CLINIC_LOGOS.map((name) => (
                    <span key={name} className="text-sm font-medium text-slate-400/90 grayscale">
                      {name}
                    </span>
                  ))}
                </div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-slate-300 font-medium">({HERO_TRUST.stars}.0)</span>
                </div>
                <p className="text-sm text-slate-200/90 italic">&ldquo;{HERO_TRUST.quote}&rdquo;</p>
              ...
              <motion.a
                ...
                className="mt-8 inline-flex flex-col items-center gap-1 text-slate-300 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-slate-900 rounded-lg py-1"
          ...
          <div className="mx-auto w-full max-w-xl lg:max-w-2xl flex-1">
            ...
            <section id="contact" className="mb-12 scroll-mt-24 rounded-2xl bg-slate-900 px-6 py-10 sm:p-12 text-center">
              ...
              <div className="mt-8 rounded-2xl border border-slate-700/80 bg-slate-800/50 px-6 py-6 sm:px-8 sm:py-7">
                <p className="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2">
                  Contact us (India)
                </p>
                <a
                  href={DEMO_PHONE}
                  className="inline-flex items-baseline gap-2 rounded-lg py-2 pr-3 -ml-1 text-xl sm:text-2xl font-bold text-white transition-all duration-200 hover:text-primary-300 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-slate-900"
                  aria-label={`Call ${CONTACT_PHONE_DISPLAY}`}
                >
                  <span className="tabular-nums">{CONTACT_PHONE_DISPLAY}</span>
                  <Phone className="h-5 w-5 sm:h-6 sm:w-6 text-primary-400 shrink-0" aria-hidden />
                </a>
                <p className="mt-1 text-sm text-slate-500">Call or WhatsApp—we’re here to help.</p>
                <div className="mt-6 flex flex-wrap justify-center gap-4">
                  <a
                    href={DEMO_PHONE}
                    className="inline-flex min-h-[48px] items-center justify-center gap-2.5 rounded-xl bg-white/10 border-2 border-slate-500 px-7 py-3.5 text-base font-semibold text-white transition-all duration-200 ease-out hover:bg-white/15 hover:border-slate-400 hover:scale-[1.02] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-slate-900"
                    aria-label="Call now"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex min-h-[48px] items-center justify-center gap-2.5 rounded-xl bg-emerald-600 border-2 border-emerald-500 px-7 py-3.5 text-base font-semibold text-white shadow-lg shadow-emerald-900/30 transition-all duration-200 ease-out hover:bg-emerald-500 hover:scale-[1.02] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:ring-offset-slate-900"
